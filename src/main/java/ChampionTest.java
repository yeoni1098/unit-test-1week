...
public class ChampionTest {
    ...
    @Test
    public void 부동소수점체크() {
        assertThat(3.14, closeTo(3, 0.2)); // 0.1일경우 에러뜸
    }

    @Test
    public void shouldNotErrorGetReference() {
        assertThat(championList.get(2), anything()); // 값을 가져오기만 하면 pass
    ...
    @Test
    public void shouldHaveSomeChmapName() {
    ...
    @Test
    public void shouldTopChampionIsDrius() {
